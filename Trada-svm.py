...
# --- 全区因子栅格文件夹（与分区栅格完全对齐）---
factor_dir = r"E:\Data\Data"  # 存放 elev.tif, slope.tif, ...
factor_names = ['DEM_1km_WGS84', 'Slope', 'Aspect', 'plan_curv', 'profile_curv', 'Curvatu','RAIN_1km_WGS84' ,
               'annual_mean_T' , 'FVC_1km_WGS84']
# --- 分区栅格 ---
zone_raster_path = r"E:\Data\SOFM\SOM_result6\SOM_5.tif"  # 像元值1~5

# --- 山西源域数据 ---
shanxi_landslide_path = r"E:\Data\Data/landslide_Plateau.shp"
shanxi_nonlandslide_path = r"E:\Data\Data\non_landslide_Plteau_prj.shp"
scaler_path = r"E:\Data\Model\SVM1\scaler.pkl"

# --- 黄土高原全区的滑坡和非滑坡点（用于每个分区的目标域样本）---
# 如果已经有每个分区独立的点文件，可以直接使用；否则提供全区点文件，脚本会自动按分区拆分
loess_landslide_path = r"E:\Data\Data\landslide_zone_250.shp"  # 全区滑坡点
loess_nonlandslide_path = r"E:\Data\Data\non_landslide_zone250.shp"  # 全区非滑坡点


# --- 输出根目录 ---
output_root = r"E:\Data\Model\TrAdaBoost-SVM1_scripr1"
